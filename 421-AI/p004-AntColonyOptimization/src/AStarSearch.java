...
public class AStarSearch {
     ...
     */
    public static LinkedList<MiddleEarth.City> aStarSearch(MiddleEarth ME, boolean winter,
                                                           int searchNum) {
        ...
        if(searchNum == 1){
            System.out.println("Our wagons cannot withstand ruinous passages."
                               + "We will favor exceptional roads.");
        } else if (searchNum == 2) {
            System.out.println("Bandits scour the roads, plundering many a merchant."
                               + "We will heavily consider our safety...");
        } else {
            System.out.println("All is calm in Middle Earth today. Our expedition"
